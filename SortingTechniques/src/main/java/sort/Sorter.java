...
public class Sorter {
    ...
    public static <T extends Comparable<T>> void sort(T[] arr, SortType sortType, boolean showSteps) {
        Sort<T> sorter = (Sort<T>) SortFactory.getSort(sortType, showSteps);
        sorter.sort(arr);
    }
     ...
     */
    public static <T extends Comparable<T>> void sort(T[] arr, String sortType, boolean showSteps) {
        sort(arr, getSortTypeFromString(sortType), showSteps);
    }
     ...
     */
    public static <T extends Comparable<T>> void sort(T[] arr, int sortType, boolean showSteps) {
        sort(arr, getSortTypeFromInt(sortType), showSteps);
    }
